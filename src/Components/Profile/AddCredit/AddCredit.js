        ...
        <ScrollView>
          ...
          <View style={styles.rupeeHead}>
            <TouchableOpacity
              style={[
                styles.rupeeSubHead,
                {backgroundColor: amount == 100 ? '#ff2746' : '#ded9d9'},
              ]}
              onPress={() => setAmount(100)}>
              <Text
                style={[
                  styles.rupee,
                  {color: amount == 100 ? '#ffffff' : 'black'},
                ]}>
                ₹100
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.rupeeSubHead,
                {backgroundColor: amount == 250 ? '#ff2746' : '#ded9d9'},
              ]}
              onPress={() => setAmount(250)}>
              <Text
                style={[
                  styles.rupee,
                  {color: amount == 250 ? '#ffffff' : 'black'},
                ]}>
                ₹250
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.rupeeSubHead,
                {backgroundColor: amount == 500 ? '#ff2746' : '#ded9d9'},
              ]}
              onPress={() => setAmount(500)}>
              <Text
                style={[
                  styles.rupee,
                  {color: amount == 500 ? '#ffffff' : 'black'},
                ]}>
                ₹500
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.rupeeSubHead,
                {backgroundColor: amount == 1000 ? '#ff2746' : '#ded9d9'},
              ]}
              onPress={() => setAmount(1000)}>
              <Text
                style={[
                  styles.rupee,
                  {color: amount == 1000 ? '#ffffff' : 'black'},
                ]}>
                ₹1000
              </Text>
            </TouchableOpacity>
          ...
          {couponCode ? (
            <View
              ...
              <View style={{position: 'absolute'}}>
                <Lottie
                  style={{width: 400}}
                  source={require('../../../assets/LottieData/ribbon.json')}
                  autoPlay
                  loop
                />
              </View>
              ...
              <TouchableOpacity onPress={onCloseCouponCode}>
          ...
          <View style={styles.main}>
            <Text
              style={[styles.rupee, styles.forMarginLeft, styles.fontRupee]}>
              ₹
            </Text>
            <TouchableOpacity style={[styles.parentOffice]}>
              <TextInput
                style={[styles.rupee, styles.fontRupee]}
                placeholder="0"
            ...
            <TouchableOpacity
              style={[
                styles.parentRedoseSpot,
                {backgroundColor: amount ? '#ff2746' : '#f7656c'},
              ]}
        ...
        <View style={styles.modalContent}>
          ...
          <View style={styles.swipeModalParent}>
            ...
            <View style={styles.Apply}>
              <TouchableOpacity>
                <Text style={styles.ApplyText} onPress={onApply}>
                  Apply
                </Text>
              </TouchableOpacity>
            </View>
